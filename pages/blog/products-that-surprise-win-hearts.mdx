...
To mention an example, in a code editor, you often want to create a new file. Sometimes it needs to be in folders, often a few levels deep, Since you want to organize your project. For example: `/docs/chapter1/newfile.md`. I'm used to it, the tedious task of making one folder (`docs`), then another one (`chapter1`), and finally, the file (`newfile.md`).

I've done this many times, so **I'm used to it**. But **every time** we do this unnecessary task, **a small pain**.

## What they did about it...

Smart folks working on the Code editor did something about this. You hit **New File** button, and you type in, `/docs/chapter1/newfile.md`. Since there's no way to include a `/` in a file name, they could know you surely want to put the new file in two-level nested folders. They create the folders (unless they already exist) and then create the new file inside the last folder.

You could never know about this feature. But one time you try typing in a path in the prompt (naturally), and it would automagically work! It feels insanely good.
...
Think of this moment. You decided to sign up for a service or to buy a product. How did you get to that point? Normally, you've read the product's features on the landing page. You almost **clearly know what it's going to do for you.**

You start using it, it does what it's supposed to do. So far you are happy. But... how you'll be in love with it? I mean, by your heart, not your mind?
